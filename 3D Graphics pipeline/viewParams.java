...
public class viewParams {
	...
	Texture textureName = new Texture(0);
	...
	public void loadTexture(String filename) throws IOException {
		...
		try {
			TextureData tex = TextureIO.newTextureData(GLProfile.getDefault(),
					str, false, "jpg");
			textureName = TextureIO.newTexture(tex);
	...
	public void setUpTextures(int program, GL2 gl2) {
		textureName.bind(gl2);
		textureName.enable(gl2);
		gl2.glUniform1i(gl2.glGetUniformLocation(program, "texturevar"), 0);
	}

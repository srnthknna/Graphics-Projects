...
public class shaderMain implements GLEventListener, KeyListener
{
    ...
    public void init(GLAutoDrawable drawable)
    {
        ...
        flat = myShaders.readAndCompile( gl2, "C:\\Users\\Srnthknna\\workspace\\JAVA\\shading\\src\\flat.vert", "C:\\Users\\Srnthknna\\workspace\\JAVA\\shading\\src\\flat.frag" );
        checkShaderError( myShaders, flat, "flat" );

        gouraud = myShaders.readAndCompile(gl2,"C:\\Users\\Srnthknna\\workspace\\JAVA\\shading\\src\\gouraud.vert","C:\\Users\\Srnthknna\\workspace\\JAVA\\shading\\src\\gouraud.frag");
        checkShaderError( myShaders, gouraud, "gouraud" );

        phong = myShaders.readAndCompile( gl2, "C:\\Users\\Srnthknna\\workspace\\JAVA\\shading\\src\\phong.vert", "C:\\Users\\Srnthknna\\workspace\\JAVA\\shading\\src\\phong.frag" );
